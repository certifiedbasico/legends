...
const novelData = {
  ...
  isCompleted: false,
  synopsis: `Un detective de primera clase resuelve los casos antes de que ocurran". Ese era el eslogan de la gran detective a quien Charlotte admiraba. Tras su muerte, Charlotte asumió casos difíciles como agente para cumplir su voluntad. Sin embargo, aunque es hábil en el combate, todavía no es buena deduciendo...

"Dedúcelo por mí".

Tras conocer a una chica llamada Sharnelia, que tiene el mismo apodo que ella, decide dejar el trabajo intelectual en sus manos.

No hace amistades. Pero unirá fuerzas si es necesario.

Charlotte solo quiere resolver el caso.

Esta es la historia de acción detectivesca de Charlotte que retrata el año previo a su reencuentro con Kimizuka.`,
  ...
  volumes: [
    {
      number: 1,
      coverImage: "/charlottev1.webp",
      pdfLink: "https://www.mediafire.com/file/uk6waomh98ae0ce/Charlotte_wa_Tada%252C_Jiken_wo_Tokitai._Tantei_wa_Mou%252C_Shindeiru._CodeRED_Vol_01.pdf/file",
      epubLink: "#",
      available: true,
