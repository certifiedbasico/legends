...
const novelData = {
  ...
  details: {
    alternativeTitles: ["Bullet Hellion: The Gunslinging Demon Prince Crushes Another World with Modern Arms, El Demonio de las balas: El principe pistolero aplasta otro mundo con armas modernas"],
    author: "-",
    illustrator: "-",
    yearPublished: "-",
    publisher: "-",
  ...
  volumes: [
    {
      number: 1,
      coverImage: "/judan.webp",
      pdfLink: "https://www.mediafire.com/file/mqbsyy5e6hrqlbi/El_Demonio_de_las_Balas_-_Volumen_01.pdf/file",
      epubLink: "#",
      available: true,
