...
const novelData = {
  ...
  isCompleted: false,
  synopsis: `Zenjiro Yamai, un oficinista en el Japón moderno, de repente se ve convocado a otro mundo. La persona que lo convocó, la Reina Aura, quiere que se case con ella y deje atrás su antigua vida por una vida de extravagancia despreocupada como su esposo y Príncipe Consorte. Le dicen que si acepta, sólo tendrá que proporcionarle un heredero.`,

  details: {
    alternativeTitles: ["-"],
    author: "Tsunehiko Watanabe",
    illustrator: "Jyruu Ayakura",
    yearPublished: "-",
    publisher: "-",
    totalVolumes: 1,
    translatedVolumes: 1,
  ...
  volumes: [
    {
      number: 15,
      coverImage: "/risou17.webp",
      pdfLink: "https://www.mediafire.com/file/xkd3nff7g9yqa7z/%255BSvartalheimer%255D._Risou_no_Himo_Seikatsu._Volumen_15_patrocinado.pdf/file",
      epubLink: "https://www.mediafire.com/file/gapq7hw08sx0wx1/%255BSvartalheimer%255D._Risou_no_Himo_Seikatsu._Volumen_15_patrocinado.epub/file",
      available: true,
